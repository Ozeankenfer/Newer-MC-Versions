 ...
 *
 */
package net.mcreator.newermcversions;
...
@Mod("newer_mc_versions")
public class NewerMcVersionsMod {
	public static final Logger LOGGER = LogManager.getLogger(NewerMcVersionsMod.class);
	public static final String MODID = "newer_mc_versions";
